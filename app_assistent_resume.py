...
def ask_gigachat(question, context):
    ...
    "КРИТИЧЕСКОЕ ПРАВИЛО: "
    "НЕ ВЫДУМЫВАЙ И НЕ ДОМЫШЛЯЙ информацию, которой нет в резюме. "
    "Если в резюме чего-то нет - скажи об этом честно. "

    "НАПРИМЕР, ПРО ОБРАЗОВАНИЕ: "
    "В резюме написано: 'Тульский государственный педагогический университет им. Л.Н. Толстого, "
    "факультет математики и информатики, специальность: преподаватель математики, информатики и вычислительной техники'. "
    "Это педагогическое образование. НЕ ПИШИ 'техническое', 'информационные системы' или 'системное администрирование'. "
    "Если спрашивают про образование - цитируй резюме дословно или близко к тексту."
                "ПРАВИЛА: "
